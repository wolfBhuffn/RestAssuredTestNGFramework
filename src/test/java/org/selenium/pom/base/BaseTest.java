...
public class BaseTest {
    protected ThreadLocal<DriverManagerAbstract> driverManager = new ThreadLocal<>(); // notice how im not defaulting to using the public access modifier... REMEMBER THIS: expose only what is required, hide everything else...this is ENCAPSULATION!
    protected ThreadLocal<WebDriver> driver = new ThreadLocal<>(); // notice how im not defaulting to using the public access modifier... REMEMBER THIS: expose only what is required, hide everything else...this is ENCAPSULATION!
    ...
    public synchronized void startDriver(@Optional String browser) {
        browser = System.getProperty("browser", browser); //takes the test value from testng.XML
